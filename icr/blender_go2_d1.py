...
def import_animation():
 ...
 # 确保时间轴覆盖 2000 帧
    ...
    bpy.context.scene.frame_end = Hrender 
    ...
    #* debug print
    # print('Hrender_start = ',Hrender_start)
    # print('Hrender_end = ',Hrender_end)
    # print("link_pos_original.shape:", link_pos_original.shape)
    # print("link_quat_wxyz_original.shape:", link_quat_wxyz_original.shape)
